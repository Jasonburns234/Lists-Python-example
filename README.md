# Lists-Python-example
# The code calculates the average haircut price, creates a new list with discounted prices, calculates the total revenue generated  # from haircuts, calculates the average daily revenue, and finally creates a list of haircuts priced under 30 dollars. The results #  are printed for each calculation.
# Hi 👋 I am Jason Burns
## Developer
